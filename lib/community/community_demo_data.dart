...
class CommunityDemoData {
  ...
  static List<DiscoveredContent> content() => [
    ...
    DiscoveredContent(
      ...
      relatedKnowledgeEntryIds: const ['k13'],
    ),
    DiscoveredContent(
      id: 'dc-4',
      companyId: hbCure,
    ...
    DiscoveredContent(
      ...
      prohibitedClaims: const [],
      relatedKnowledgeEntryIds: const ['k7'],
    ),
    DiscoveredContent(
      id: 'dc-9',
      companyId: schnurrPurr,
  ...
  static List<CommunityMember> members() => [
    // --- Cat cluster: rich matching situations against dc-1 (SchnurrPurr) ---
    const CommunityMember(
      ...
      experienceCategories: ['katzen', 'entspannung'],
      isVerified: true,
      ...
      supportedDomains: [HumanIntelligenceDomain.communityEngagement],
    ...
    const CommunityMember(
      ...
      preferredActions: [CommunityActionType.personalExperience],
      supportedDomains: [HumanIntelligenceDomain.communityEngagement],
      profileAnalysisConsent: true,
      isAvailable: true,
    ),
    const CommunityMember(
      ...
      preferredActions: [CommunityActionType.factualAnswer],
      supportedDomains: [
        HumanIntelligenceDomain.communityEngagement,
        HumanIntelligenceDomain.productTest,
      ],
      profileAnalysisConsent: true,
      isAvailable: true,
    ),
    ...
    const CommunityMember(
      ...
      supportedDomains: [
        HumanIntelligenceDomain.communityEngagement,
        HumanIntelligenceDomain.translation,
      ],
      profileAnalysisConsent: true,
      isAvailable: true,
    ),
    const CommunityMember(
      ...
      preferredActions: [CommunityActionType.shortPersonalComment],
      supportedDomains: [HumanIntelligenceDomain.communityEngagement],
      profileAnalysisConsent: true,
      isAvailable: false,
    ),
    // Language conflict: writes English but topic/platform fit dc-1.
    const CommunityMember(
      id: 'm-9',
      displayName: 'Elif (Demo)',
      country: 'DE',
      languages: ['en'],
      platformProfiles: [
        MemberPlatformProfile(
      ...
      declaredInterests: ['katzen', 'entspannung'],
      verifiedTopics: ['katzen'],
      publicActivityTopics: ['katzen'],
      writingStyle: 'freundlich',
      experienceCategories: ['katzenhaltung'],
      isVerified: true,
      accountAuthenticityScore: 80,
      qualityScore: 74,
      availability: 'abends',
      compensationEnabled: true,
      disclosureRequirements: ['bezahlte Partnerschaft kennzeichnen'],
    ...
    // Platform missing: strong fit but not active on Reddit.
    const CommunityMember(
      id: 'm-10',
      displayName: 'Bea (Demo)',
      country: 'DE',
      languages: ['de'],
      platformProfiles: [
        MemberPlatformProfile(
    ...
    // Topic excluded: never wants "stress" tasks (dc-1 carries that topic).
    const CommunityMember(
      id: 'm-11',
      displayName: 'Cem (Demo)',
      country: 'DE',
      languages: ['de'],
      platformProfiles: [
        MemberPlatformProfile(
      ...
      declaredInterests: ['katzen'],
      verifiedTopics: ['katzen'],
      publicActivityTopics: ['katzen'],
      writingStyle: 'direkt',
      experienceCategories: ['katzenhaltung'],
      isVerified: true,
      accountAuthenticityScore: 85,
      qualityScore: 80,
      availability: 'abends',
      compensationEnabled: true,
      disclosureRequirements: ['bezahlte Partnerschaft kennzeichnen'],
      ...
      preferredActions: [CommunityActionType.personalExperience],
      supportedDomains: [HumanIntelligenceDomain.communityEngagement],
      excludedTopics: ['stress'],
      profileAnalysisConsent: true,
      isAvailable: true,
    ),
    // Company excluded: never wants SchnurrPurr tasks.
    const CommunityMember(
      id: 'm-12',
      displayName: 'Doro (Demo)',
      country: 'DE',
      languages: ['de'],
      platformProfiles: [
        MemberPlatformProfile(
      ...
      verifiedTopics: ['katzen'],
      publicActivityTopics: ['katzen'],
      writingStyle: 'herzlich',
      experienceCategories: ['katzenhaltung'],
      isVerified: true,
      accountAuthenticityScore: 88,
      qualityScore: 82,
      availability: 'abends',
      compensationEnabled: true,
      disclosureRequirements: ['bezahlte Partnerschaft kennzeichnen'],
      ...
      preferredActions: [CommunityActionType.personalExperience],
      supportedDomains: [HumanIntelligenceDomain.communityEngagement],
      excludedCompanyIds: ['schnurr-purr'],
      profileAnalysisConsent: true,
      isAvailable: true,
    ),
    // Missing consent: public activity would match but must not be used.
    const CommunityMember(
      id: 'm-13',
      displayName: 'Ferda (Demo)',
      country: 'DE',
      languages: ['de'],
      platformProfiles: [
        MemberPlatformProfile(
      ...
      declaredInterests: [],
      verifiedTopics: [],
      publicActivityTopics: ['katzen', 'entspannung'],
      writingStyle: 'knapp',
      experienceCategories: [],
      isVerified: false,
      accountAuthenticityScore: 72,
      qualityScore: 64,
      availability: 'flexibel',
      compensationEnabled: true,
      disclosureRequirements: ['Verbindung offenlegen'],
      ...
      preferredActions: [CommunityActionType.shortPersonalComment],
      supportedDomains: [HumanIntelligenceDomain.communityEngagement],
      profileAnalysisConsent: false,
      isAvailable: true,
    ),
    // Currently unavailable: strong fit but paused availability.
    const CommunityMember(
      id: 'm-14',
      displayName: 'Gino (Demo)',
      country: 'DE',
      languages: ['de'],
      platformProfiles: [
        MemberPlatformProfile(
      ...
      experienceCategories: ['katzenhaltung'],
      isVerified: true,
      accountAuthenticityScore: 86,
      qualityScore: 81,
      availability: 'zurzeit nicht verfügbar',
      compensationEnabled: true,
      disclosureRequirements: ['bezahlte Partnerschaft kennzeichnen'],
      status: MemberStatus.active,
      completedTaskCount: 7,
